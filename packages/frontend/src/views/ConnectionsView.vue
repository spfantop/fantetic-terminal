...
const SERVER_PANEL_MIN_WIDTH = 200;
const SERVER_PANEL_DEFAULT_WIDTH = 220;
...
.server-list-panel {
  ...
  --server-list-primary-font-size: 1rem;
  --server-list-secondary-font-size: 0.86rem;
  --server-list-badge-font-size: 0.76rem;
...
.server-list-title span {
  ...
  font-size: var(--server-list-badge-font-size);
  font-weight: 700;
  line-height: 1.2;
  text-align: center;
}
...
.server-select {
  ...
  background: var(--app-bg-color);
  color: var(--text-color);
  font-size: var(--server-list-secondary-font-size);
  outline: none;
...
.server-folder-header {
  ...
  color: var(--text-color);
  cursor: pointer;
  font-size: var(--server-list-primary-font-size);
  font-weight: 600;
  text-align: left;
  transition: background-color 0.12s ease, border-color 0.12s ease;
}
