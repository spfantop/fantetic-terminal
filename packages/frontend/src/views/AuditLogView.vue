<template>
  <div class="p-4 md:p-6 lg:p-8 bg-background text-foreground"> <!-- Outer container with dashboard-like padding -->
    <div class="w-full"> <!-- Keep content aligned with the dashboard instead of centered in a narrow shell -->
