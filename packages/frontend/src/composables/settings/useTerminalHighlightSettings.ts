...
import { previewTerminalRenderHighlightSegments } from '../../utils/terminalRenderHighlighter';
...
2026-07-05 22:55:11.456 INFO response={"code":200,"success":true,"url":"https://example.com/api?id=1","ip":"10.0.0.2","message":"JSON key/string/number/literal 使用语义颜色"} cost=35ms
{"code":500,"success":false,"message":"外层括号醒目，内部标点弱化","data":null,"traceId":"adMm1224399051239198720","ip":"192.168.1.10"}
