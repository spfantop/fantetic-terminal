...
.layout-node-editor {
  ...
  border-radius: 6px;
  background: color-mix(in srgb, var(--header-bg-color) 72%, var(--app-bg-color));
...
.node-controls {
  ...
  align-items: center;
  background-color: color-mix(in srgb, var(--header-bg-color) 90%, var(--app-bg-color));
...
.action-button {
  background: color-mix(in srgb, var(--button-bg-color) 16%, var(--header-bg-color));
...
.action-button:hover {
  background-color: color-mix(in srgb, var(--button-bg-color) 34%, var(--header-bg-color));
...
.remove-button {
  ...
  border-color: color-mix(in srgb, var(--color-error) 55%, var(--border-color));
  background: color-mix(in srgb, var(--color-error) 10%, var(--header-bg-color));
}
.remove-button:hover {
  background-color: color-mix(in srgb, var(--color-error) 18%, var(--header-bg-color));
  color: var(--color-error);
}
...
.node-children-container {
  ...
  border: 1px dashed color-mix(in srgb, var(--border-color) 82%, var(--text-color-secondary));
  background: color-mix(in srgb, var(--header-bg-color) 82%, var(--app-bg-color));
...
.drag-handle-node {
  ...
  background-color: color-mix(in srgb, var(--header-bg-color) 94%, var(--app-bg-color));
...
.empty-container-placeholder {
  ...
  background: color-mix(in srgb, var(--header-bg-color) 78%, var(--app-bg-color));
