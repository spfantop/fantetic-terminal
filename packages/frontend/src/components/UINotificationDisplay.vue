...
<template>
  <div class="ui-notifications fixed top-4 right-4 z-[1100] flex flex-col items-end">
    <transition-group
      tag="div"
    ...
    >
      <div
        ...
        :key="notification.id"
        :class="[
          'notification-surface flex items-center p-3 mb-2 rounded shadow-md min-w-[250px] max-w-[400px] opacity-95 text-white', 
          {
...
<style scoped>
.ui-notifications {
  view-transition-name: ui-notifications;
}
