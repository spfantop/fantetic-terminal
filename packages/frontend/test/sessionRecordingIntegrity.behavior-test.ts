...
assert.match(component, /startRemoteDesktopProgressTicker/);
assert.match(component, /remoteDesktopRecording\.getPosition\?\.\(\)/);
assert.match(component, /remoteDesktopProgressAnchorSpeed/);
