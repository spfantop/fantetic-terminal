...
const controller = readFileSync(resolve('src/session-recording/session-recording.controller.ts'), 'utf8');
...
assert.match(controller, /deleteRecordingsForSubject/);
assert.match(controller, /sessionRecording\.deleteBatchEmpty/);
assert.match(service, /deleteRecordingForSubject/);
assert.match(service, /deleteRecordingsForSubject/);
