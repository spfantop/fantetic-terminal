...
export const tableDefinitions: TableDefinition[] = [
    ...
    { name: 'connection_folders', sql: schemaSql.createConnectionFoldersTableSQL },
    { name: 'connections', sql: schemaSql.createConnectionsTableSQL }, // Depends on proxies, ssh_keys, connection_folders
