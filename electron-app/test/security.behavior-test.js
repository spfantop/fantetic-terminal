...
const frontendUrl = 'http://127.0.0.1:22457';
...
assert.equal(isTrustedRendererUrl('http://127.0.0.1:22458/', frontendUrl), false);
...
assert.deepEqual(
  addElectronNonceHeader({ url: 'ws://127.0.0.1:22458/ws/', requestHeaders: { Upgrade: 'websocket' } }, 'nonce-value'),
